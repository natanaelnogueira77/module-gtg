<div class="card">
    ...
    <div class="card-footer d-block text-center">
        ...
        <button type="button" id="ml-choose" class="btn btn-primary btn-lg"><?= _('Escolher') ?></button>
        <button type="button" id="ml-list-cancel" class="btn btn-danger btn-lg"><?= _('Voltar') ?></button>
    </div>
</div>