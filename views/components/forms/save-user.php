<form id="<?= $view->id ?>" action="<?= $view->isAccountEdit ? $view->action : '' ?>" 
    method="<?= $view->isAccountEdit ? $view->method : '' ?>">
    <div class="row">
        <div class="form-group col-md-6 mb-3">
            <label for="name">
                <?= _('Nome') ?>
                <span data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="<?= _('Digite um nome.') ?>">
            ...
            <input type="text" class="form-control" name="name" placeholder="<?= _('Digite um nome...') ?>" 
                maxlength="100" value="<?= $view->user?->name ?>">
        ...
        <div class="form-group col-md-6 mb-3">
            <label for="email">
                <?= _('Email') ?>
                <span data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="<?= _('Digite um email válido.') ?>">
                    <i class="icofont-question-circle" style="font-size: 1.1rem;"></i>
                </span>
            </label>
            <input type="email" class="form-control" name="email" placeholder="<?= _('Digite um email...') ?>" 
                maxlength="100" value="<?= $view->user?->email ?>">
            <div class="invalid-feedback"></div>
        </div>
    </div>
    
    <div class="row">
        <?php if(!$view->isAccountEdit): ?>
        <div class="form-group col-md-5 mb-3">
            <label for="user_type">
                <?= _('Nível de Permissão') ?>
                <span data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="<?= _('Escolha um nível de permissão.') ?>">
                    <i class="icofont-question-circle" style="font-size: 1.1rem;"></i>
                </span>
            </label>
        ...
        <div class="col-md-7 mb-3">
            ...
            <div id="password-area" class="form-group" style="<?= $view->isAccountEdit ? 'display: none;' : '' ?>">
                <label for="password">
                    <?= _('Senha') ?>
                    <span data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="<?= _('Digite a senha de acesso à sua conta.') ?>">
                        <i class="icofont-question-circle" style="font-size: 1.1rem;"></i>
                    </span>
                </label>
    ...
    <div class="row">
        <div class="form-group col-md-12 mb-3">
            ...
            <div id="avatar-image-area" data-uri="<?= $view->user?->getAvatarImageURI() ?>" 
                data-url="<?= $view->user?->getAvatarImageURL() ?>"></div>
