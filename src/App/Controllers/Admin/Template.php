...
class Template extends Controller 
{
    public function addData(): void 
    {
        ...
        $lang = getLang()->setFilepath('controllers/admin/template')->getContent();
        ...
        $leftMenu = [
            ...
            [
                'type' => 'heading', 
                'desc' => $lang->get('left.menu.heading2')
            ],
            [
                'type' => 'item', 
                'level' => 1, 
